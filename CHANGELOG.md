...
- Settings auto-save: Changes are now saved automatically without manual save button

### Documentation

- Add Sentry Performance Monitoring to roadmap
- Clarify language support status (Japanese ↔ English only)
- Update Keychain storage documentation
...
[Unreleased]: https://github.com/ebiyy/traylingo/compare/v0.1.4...HEAD
[0.1.4]: https://github.com/ebiyy/traylingo/compare/v0.1.3...v0.1.4
